...
def make_buttons():
    buttons = []
    buttons.append(Button(window, WIDTH//5-50, 50, 100, 30, text="RUN", color=(28, 111, 51),
                          hover_color=(48, 131, 82), bold_text=True, function=run_game))
    buttons.append(Button(window, WIDTH//2-50, 50, 100, 30, text="PAUSE", color=(18, 104, 135),
                          hover_color=(51, 168, 212), bold_text=True, function=pause_game))
    buttons.append(Button(window, WIDTH//1.2-50, 50, 100, 30, text="RESET", color=(117, 14, 14),
                          hover_color=(217, 54, 54), bold_text=True, function=reset_grid))
